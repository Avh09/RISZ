...
VSS_SERVER_URL = "http://127.0.0.1:8000/check_similarity" # <-- NEW
...
def query_vss_server(vector): # <-- NEW
        ...
        with conn:
            ...
            try:
                ...
                if not check_timestamp(M1['TS1'], DELTA_T):
                    raise ValueError("M1 timestamp check failed.")
                ...
                session_user_id = IDi_stored # <-- Save for CA phase
                ...
                session_key = SK_ji # <-- Save for CA phase
                ...
                # Calculate the IV for the CA phase 
                # session_iv = h(t3, M3['TS3'])
                ...
                while True:
                    ...
                    # 4. The Critical Check [cite: 285-286, 291]
